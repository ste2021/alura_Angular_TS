...
#### [*] First you need to have Node JS <img src="https://github.com/ste2021/images-icons/blob/master/icons8-nodejs.svg" width=28 height=35 />installed, start by running the following command in the terminal:
